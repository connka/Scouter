      ...
      <div className="modal-container">
        <div className="modal-content">
          ...
          <div className="modal-info">
            <p>Power Scouter is a data graphing app for power generation in Alberta made by Taylor Cameron, Alex Buch, and Katherine Connolly for Lighthouse Labs in Calgary.<br></br><br></br>
