            ...
            <div className="sunburst-wrapper">
              <div className="block">
                <div className="sunburst-title">
                  ...
                  <img className="directions-button"
                  onClick={this.props.setModalData}
                  src={require("../../docs/directions.png")}
                  alt="Icon made by http://www.freepik.com/ from https://www.flaticon.com" />
                </div>
                <Sunburst data={this.props.sunburstData} colorType={"category"} colorRange={DIVERGING_COLOR_SCALE} style={{ stroke: "#fff" }} onSelect={this.onSelect} scale="linear" tooltipContent={<div class="sunburstTooltip" style="position:absolute; color:'black'; z-index:10; background: #e2e2e2; padding: 5px; text-align: center;" />} tooltip tooltipPosition="right" keyId="anagraph" width="700" height="600" />
              </div>
            </div>
          </div>;
    }
